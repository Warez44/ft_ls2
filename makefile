...
#    Updated: 2018/11/27 12:49:56 by clingier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/dir_handler.c src/err_handler.c src/ft_flags.c src/ft_ls.c\
...
OBJ = dir_handler.o err_handler.o ft_flags.o\
